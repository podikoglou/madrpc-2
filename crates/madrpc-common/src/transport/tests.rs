...
mod tests {
    ...
    use crate::transport::PostcardCodec;
    use serde_json::json;
    ...
    fn test_encode_decode_request() {
        ...
        let encoded = PostcardCodec::encode_request(&original).unwrap();
    ...
    fn test_encode_decode_response() {
        ...
        let encoded = PostcardCodec::encode_response(&original).unwrap();
        assert!(!encoded.is_empty());
    ...
    fn test_invalid_request_data_returns_error() {
        ...
        let result = PostcardCodec::decode_request(&invalid_data);
    ...
    fn test_invalid_response_data_returns_error() {
        ...
        let result = PostcardCodec::decode_response(&invalid_data);
        assert!(result.is_err());
    }
